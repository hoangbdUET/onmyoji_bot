...
class TansuoPos():
    ...
    gouliang_left = (161, 174), (322, 288)  # Dog food position on the left
    gouliang_middle = (397, 218), (500, 349)  # Middle dog food position
    gouliang_right = (628, 293), (730, 430)  # Dog food position on the right
    gouliang_leftback = (0, 273), (150, 393)  # Rear left dog food position
    gouliang_rightback = (433, 462), (567, 569)  # Rear right dog food position
...
class YuhunPos():
    tiaozhan_btn = (995, 533), (1055, 595)    # Gosoul Challenge Button
    kaishizhandou_btn = (1048, 535), (1113, 604)   # Yusoul start battle button
    yuhun_menu = (148, 568), (206, 620)    # Yusoul Menu
    yuhun_btn = (147, 152), (327, 408)    # Yushun option
