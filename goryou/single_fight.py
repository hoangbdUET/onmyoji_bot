...
class GoryouFight(Fighter):
    '''Single player soul fighting, parameters done, emyc'''
    ...
    def start(self):
        ...
        mood3 = ut.Mood(3)
        while self.run:
            # Detect whether the settlement was successful in the previous step, and prevent abnormalities caused by the fact that the vibrating egg is not detected for a moment
            ...
            # Click the "Challenge" button in the main menu of Yushun, you need to use "lineup lock"!
