...
class ExploreFight(Fighter):
    def __init__(self, hwnd=0, mode=0):
        ...
        initialization
            ...
            :param mode=0: Dog food mode: 0-normal mode, 1-row dog food after team
        '''
    ...
    def check_exp_full(self):
        '''
        Check dog food experience and automatically change dog food
        Dog food sequence, 1-left; 2-middle; 3-right; 4-left rear; 5-right rear
        '''
        if self.gouliang == None:
            return

        # Dog food experience judgment
        gouliang = []
        ...
        # Start changing dog food
        while self.run:
            # Click on the position of dog food
    ...
    def find_exp_moster(self):
        '''
            ...
            return: Successfully return to the position of the attack icon of the experience monster; otherwise, return -1
        '''
    ...
    def find_boss(self):
        '''
        Find the boss
            :return: Successfully return to the position of the BOSS attack icon; otherwise, return -1
        '''
