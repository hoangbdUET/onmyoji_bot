...
class GameControl():
    ...
    def mouse_move(self, pos, pos_end=None):
        ...
        Simulate mouse movement
             ...
             :param pos_end=None: (x,y) If pos_end is not empty, the mouse moves to a random position in the area where pos is the upper-left corner coordinate and pos_end is the lower-right corner coordinate
        """
    ...
    def quit_game(self):
        ...
        logging.info('Exit, and finally show that it has been saved to the /img/screenshots folder')
        sys.exit(0)
