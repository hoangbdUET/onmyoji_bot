...
class SingleFight(Fighter):
    '''Single-player Royal Soul battle, parameter done, emyc'''
    ...
    def start(self):
        '''Single player battle main loop'''
        mood1 = ut.Mood()
        mood2 = ut.Mood()
        mood3 = ut.Mood(3)
        ...
        while self.run:
            # In the Yuhun main menu, click the "Challenge" button, you need to use the "lineup lock"!
