...
class Application(tk.Frame):
    ...
    def create_menubar(self):
        ...
        menu1.add_command(label='Start Onmyoji', command=self.start_onmyoji)
        menu1.add_command(label='Stop Onmyoji', command=self.stop_onmyoji)
    ...
    def create_client(self):
        ...
        self.client['value'] = ('Onmyoji desktop version-default resolution', 'MuMu simulator-1136*640 (100% zoom)')
    ...
    def create_section(self):
        ...
        self.section.add(self.frame0, text='Mikun')

        # Create tab 2-Yuling
        self.frame1 = tk.Frame(self.section)
        self.section.add(self.frame1, text='Yuling')
        ...
        self.section.add(self.frame3, text='On')
    ...
    def create_frame0(self):
        ...
        tk.Radiobutton(submode, text='Yaki Orochi', variable=self.run_submode,
                       value=0).grid(row=0, column=0, sticky=tk.W)
        ...
        tk.Label(mitama_mark, text='Mark your own way god:').pack(side=tk.LEFT)
    ...
    def create_frame1(self):
        ...
        text.insert(tk.END, 'Select the Yuling and the number of layers you want to play, and click the start button.')
    ...
    def create_frame2(self):
        ...
        # Dog food settings
        food = tk.LabelFrame(self.frame2, text='Change dog food (do not lock the lineup)')
        ...
        # Change dog food settings
        tk.Checkbutton(self.frame2, text='Change dog food drag and drop god progress bar, progress:',
        ...
        self.cmb['value'] = ('Change material', 'Replace N card', 'Replace R card')
    ...
    def create_advance(self):
        ...
        tk.Label(frame, text=' Screen timeout (seconds):').grid(row=0, column=0)
    ...
    def gouliang_state(self, state):
        '''Disable dog food option
            :param state: 1-Only enable 3 dog food, 2-Disable 3 dog food, 3-Enable all
...
At the same time, one of the 1-3 delays is selected as the secondary delay. Multiply the random coefficient on this basis。\n\n')
        ...
        tk.Label(row2, text='Level 4: ').grid(row=4, column=0)
